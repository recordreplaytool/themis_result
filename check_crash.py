...
app_crash_data = {
    ...
    'FirefoxLite': {
        ...
        '#4881': ["org.json.JSONException: End of input at character 0 of",
                  "org.json.JSONTokener.nextValue(JSONTokener.java",
                  "org.mozilla.rocket.home.contenthub.data.ContentHubRepoKt.jsonStringToTypeList(ContentHubRepo.kt",
                  "org.mozilla.rocket.home.contenthub.data.ContentHubRepo$getReadTypesLive",
                  "androidx.fragment.app.FragmentManager.moveToState(FragmentManager.java",
                  "androidx.lifecycle.LiveData$ObserverWrapper.activeStateChanged(LiveData.java",
                  ],
    ...
    'Omni-Notes': {
        '#377': ['ACRA caught a NumberFormatException for it.feio.android.omninotes.foss',
                 'it.feio.android.omninotes.DetailFragment.lambda$initViewReminder'],
